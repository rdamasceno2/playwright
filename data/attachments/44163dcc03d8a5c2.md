...
Locator: locator('.left.mt-1 p')
Expected string: "Automation Practice"
Received: <element(s) not found>
Call log:
  - expect.toHaveText with timeout 60000ms
  - waiting for locator('.left.mt-1 p')

    at /home/runner/work/playwright/playwright/tests/login.spec.js:14:52
```
...
- text: Email
- textbox "email@example.com": damasceno999@gmail.com
- text: Password
- textbox "enter your passsword": Learning1
- button "Login"
